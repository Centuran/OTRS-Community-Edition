...
;
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE oauth2_token ADD CONSTRAINT FK_oauth2_token_config_id_id FOREIGN KEY (config_id) REFERENCES oauth2_token_config (id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX FK_oauth2_token_config_id ON oauth2_token (config_id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
